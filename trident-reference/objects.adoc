...
| Tipo fstype | cadena | ext4, ext3, xfs, etc. | El tipo de sistema de archivos para los volúmenes de bloques | solidfire-san, ontap-nas, ontap-nas-economy, ontap-nas-flexgroup, ontap-san, ontap-san-económico, eseries-iscsi | Todo 
...
| VolumeBindingMode | cadena | Inmediatamente, WaitForFirstConsumer | Elija cuándo se producen el enlace de volumen y el aprovisionamiento dinámico | Todo | 1.17 o posterior 
|===
[TIP]
====
